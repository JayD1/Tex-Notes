...
\begin{prop}[\highlight{Riemannain Newton and FP-SQP}]
...
\begin{prop}[\highlight{Critical Points}]
...
\begin{prop}[\highlight{KKT conditions}]
...
\begin{prop}[\highlight{Lojasiewicz inequality}] \label{prop:Lojasiewicz_inequality}
...
\begin{mydef}[\highlight{Polyak-Lojasiewicz inequality}] \label{def:pl_inequality}
...
\begin{prop}[\highlight{Second-order Necessary Conditions}]
...
\begin{prop}[\highlight{Second-order Sufficient Conditions}]
...
\begin{mydef}[\highlight{Gradient-related sequence}]
...
\begin{mydef}[\highlight{Armijo point}]
...
\begin{prop}[\highlight{Convergence of ALS}]
...
\begin{prop}[\highlight{Unstable fixed points}] \label{prop:unstable_fixed_points}
...
\begin{prop}[\highlight{Capture Theorem}] \label{prop:capture_theorem}
...
\begin{prop}[\highlight{Preconditioned Riemannian Metric}] \label{prop:preconditioned_metric}
...
\begin{prop}[\highlight{Product Manifold}]
