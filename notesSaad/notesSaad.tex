...
(L^{-1}_m)_{i,j} = 
     ...
     \end{cases}
\]
Now notice that, $L^{-1}_me_1$ will give the first column of $L^{-1}_m$ and similarly $e^T_mL^{-T}_m = (L^{-1}_me_m)^T = e^T_m$ and hence $e^T_mD^{-1}_m=\frac{1}{\eta_m}e^T_m$. Then $$c_m=-\dfrac{\beta_0\beta_{m+1}}{\eta_m}e^T_mL^{-T}_me_1=-\dfrac{\beta_0\beta_{m+1}}{\eta_m}(L^{-1}_m)_{m,1}=\dfrac{(-1)^{m}}{\eta_m}\beta_0\beta_{m+1}\underset{i=2}{\overset{m}{\prod}}\lambda_i.$$
Therefore, $r_m = c_mv_{m+1}$, where $c_m=\dfrac{(-1)^{m}}{\eta_m}\beta_0\beta_{m+1}\underset{i=2}{\overset{m}{\prod}}\lambda_i.$ 
