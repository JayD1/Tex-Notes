...
$$\|b-\mathcal{Q}^\mathcal{L}_\nmathcal{K}A\mathcal{P}_\mathcal{K}x_*\|_2\le\gamma\|(I-\mathcal{P}_\mathcal{K})x_*\|_2.$$
\end{theorem}
...
\item Conjugacy Conditions on $p_i$'s gives $(r_{j+1}-\beta_jp_j,Ap_j)=0$\\$\implies(r_{j+1}-\beta_jp_j,-\frac{1}{\alpha_j}(r_{j+1}-r_j))=0$, as a result,
