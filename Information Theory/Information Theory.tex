...
\begin{proof}
    ...
    \begin{gather*}
        ...
        \Var\left(\dfrac{Z_k}{n}\right) = \left(\E\left[ \dfrac{Z_k}{n} - \E\left[ \dfrac{Z_k}{n} \right] \right]\right)^2 = \left(\E\left[ \dfrac{Z_k}{n} - \dfrac{\mu}{n} \right]\right)^2 = \dfrac{\left(\E\left[ Z_k - \mu \right]\right)^2}{n^2} = \dfrac{\sigma^2}{n^2}, \\
...
\begin{theorem}[Properties of Typical Sequence]
    ...
    \begin{enumerate}[(a)]
        ...
        \begin{equation*}
            2^{-n(1+\varepsilon)H(X)} \le \Prob\left[X^{(n)}\in\T^{(n)}_\varepsilon\right] \le 2^{-n(1-\varepsilon)H(X)}.
        \end{equation*}
