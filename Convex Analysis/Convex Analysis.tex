...
\begin{remark}
    From the above proposition, the collection of convex subsets in $\R^n$ is a \highlight{complete} \highlight{lattice} under the natural partial order corresponding to inclusion.
\end{remark}
...
% def:convex_cone_generated_by_a_set
% remark:convex_cone_generated_by_a_set
